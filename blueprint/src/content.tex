...
Note that the meaning of the notation $F(\sqrt{a})$ depends on whether $a$ is a square in $F$. We take care to use this notation only in the non-trivial case. The same applies to $F(i)$.
