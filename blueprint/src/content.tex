...
\begin{lemma}
  ...
  \lean{Polynomial.has_root_of_odd_natDegree_imp_not_irreducible}
  \leanok
...
\begin{lemma}
  ...
  \uses{def:preordering}
  \lean{IsPreordering.eq_zero_of_mem_of_neg_mem}
  \leanok
...
\begin{lemma}
  ...
  \lean{ringOrderingLinearOrderEquivField}
  \leanok
...
\begin{lemma}
  ...
  \uses{def:preordering}
  \lean{IsPreordering.neg_one_notMem_adjoin_of_neg_notMem}
  \leanok
...
\begin{lemma}
  ...
  \uses{def:ordering}
  \lean{IsPreordering.isOrdering_of_maximal}
  \leanok
...
\begin{lemma}
  ...
  \uses{def:ordering}
  \lean{IsPreordering.exists_le_isOrdering}
  \leanok
...
\begin{proof}
  \leanok
  \uses{cor:ext_ord_to_adj_sqrt,lem:odd_deg_red_imp_root,lem:ext_ord_odd_deg}
