...
\begin{lemma}
  ...
  Let $F$ be an ordered field with a real closure $\bar{F}$, and let $K/F$ be a finite ordered extension. Then there is an ordered $F$-homomorphism $K\to\bar{F}$.
\end{lemma}
\begin{proof}
  TODO, needs Sturm's theorem
\end{proof}
